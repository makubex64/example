...
export default function About(){
	...
	return(
		...
		<div className="container mx-auto flex flex-row py-20 mb-20 items-center text-center ">



		<div class="flex flex-wrap">
		  <div class="about-1 md:max-lg:w-2/5  lg:w-1/3  flex items-center ">
				<img className="myself-Image"  src={Person} />
		  </div>

		  <div class="about-2 pl-12 pr-12  md:max-lg:w-3/5 lg:w-2/3 flex flex-col justify-center ">
